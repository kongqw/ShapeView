...
open class XButton(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : AppCompatButton(context, attrs, defStyleAttr), IGrayMode, ICorner, IBackground, ITextColor {
