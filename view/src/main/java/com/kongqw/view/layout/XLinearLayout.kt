...
open class XLinearLayout(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : LinearLayout(context, attrs, defStyleAttr), IGrayMode, ICorner, IBackground {
    ...
    private var mAttributeParams: AttributeParams = AttributeHelper.obtainStyledAttributes(context, attrs, object : IAttributeParams {
        override fun onAttrsId(): IntArray = R.styleable.XLinearLayout
        override fun isGrayMode(): Int = R.styleable.XLinearLayout_isGrayMode
        ...
        override fun onCornerTypeIndex(): Int = R.styleable.XLinearLayout_cornerType
        override fun onCornerRadiusIndex(): Int = R.styleable.XLinearLayout_cornerRadius

        override fun onBackgroundColorOrientationIndex(): Int = R.styleable.XLinearLayout_backgroundColorOrientation
        override fun onBackgroundColorsIndex(): Int = R.styleable.XLinearLayout_backgroundColors
        override fun onBackgroundPressedColorsIndex(): Int = R.styleable.XLinearLayout_backgroundPressedColors
        override fun onBackgroundDisabledIndex(): Int = R.styleable.XLinearLayout_backgroundDisabledColors

        override fun onStrokeWidthIndex(): Int = R.styleable.XLinearLayout_strokeWidth
        override fun onStrokePressedWidthIndex(): Int = R.styleable.XLinearLayout_strokePressedWidth
        override fun onStrokeDisabledWidthIndex(): Int = R.styleable.XLinearLayout_strokeDisabledWidth
        override fun onStrokeColorIndex(): Int = R.styleable.XLinearLayout_strokeColor
        override fun onStrokePressedColorIndex(): Int = R.styleable.XLinearLayout_strokePressedColor
        override fun onStrokeDisabledColorIndex(): Int = R.styleable.XLinearLayout_strokeDisabledColor
    })
